...
@section('title', 'Qeydiyyat - '.env('APP_NAME'))
...
<section class="contact-section section_padding">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col">
            <form method="POST" class="form-contact contact_form" action="{{ route('register') }}">
                @csrf

                <div class="form-group row">
                    <label for="name" class="col-md-4 col-form-label text-md-right">İstifadəçi adı</label>
                ...
                <div class="form-group row">
                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Şifrə təsdiqi</label>
